                ...
                <form onSubmit={onSubmitHandler}>
                    ...
                    <div className='grid grid-cols-2 gap-6 mt-8'>
                        <label>
                            ...
                            <input required type='text' minLength={3} maxLength={6} className='p-4 mb-6 rounded-lg bg-transparent focus:outline-none border-[1px] border-gray-600 w-full mt-2' placeholder='Enter Token Name e.g. $LOOK' value={formData.tokenName} onChange={(e) => handleChange(e, 'tokenName')} />
                        </label>
                        <label>
