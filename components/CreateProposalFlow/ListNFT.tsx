...
const ListNFT: React.FC<SelectProposalProps> = ({
  setCurrentStep,
  handleBack
}) => {
    ...
    <div className='pb-8 text-lg max-w-2xl mx-auto '>
      <div className='max-w-2xl mx-auto text-lg flex items-center justify-between h-28 p-6 bg-[url("/Button.png")]  bg-[#232529]    bg-cover overflow-hidden rounded-2xl '>
        ...
        <div className='text-white'>
          <h2 className=' text-2xl font-normal font-britanica '>List NFT for Sale</h2>
          <p className='text-lg font-montserrat'>List you vault’s NFT for sale</p>
        </div>
        <div className='mt-20'>
      ...
      <form onSubmit={onSubmitHandler}>
        ...
        <div className='flex mt-6 space-x-10 '>
          <label className='flex-[0.3]'>
            <p className='text-xl mt-1 font-britanica font-normal'>PLatform for Sale</p>
            <Select
              options={option}
              value={inputType}
          ...
          <label className='flex-[0.7] relative'>
            <p className='text-xl mt-2 font-britanica font-normal'>Listing Price in (eth)?</p>
