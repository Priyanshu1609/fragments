        ...
        <div className='max-w-2xl mx-auto text-lg'>
            <div className='flex items-center justify-between h-28 p-6 bg-[url("/Button.png")] bg-[#232529] bg-cover overflow-hidden rounded-2xl'>
                <div className='text-white'>
                    <h2 className=' text-3xl font-semibold'>Governance Parameters Commitee</h2>
                    ...
                    <div className='flex flex-col space-y-4 my-6'>
                        <label className='relative '>
                            <div className='text-xl flex items-center '>
                                <p className='mr-1 font-britanica font-normal'>Add Committee Wallet Addresses <span className='text-base text-gray-300'>( Use comma to add multiple addresses )</span></p>
                                <div className='group'>
