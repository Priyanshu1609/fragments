                ...
                <div className='p-4 mt-6'>
                    <div className='flex items-center justify-evenly  text-white hover:cursor-pointer'>
                        <div
                            ...
                            className='h-44 w-48 py-3 flex flex-col  hover:bg-gray-700 space-x-2 justify-center items-center px-4 text-sm rounded-3xl !border-[1px]  !border-red-300 text-left '
                        >
